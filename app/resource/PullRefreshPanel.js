 ...
 * 
 * 
 * This plugin adds pull to refresh functionality to a Panel. ## Example
 * 
 */

Ext.define('PaperVan.resource.PullRefreshPanel', {
	...
	init : function(list) {
		...
		if ((this.isList = list.getStore && list.getStore() ? true : false) == true) { // is
			// list
			// a
			// list
			// ?
		...
		var me = this, pullTpl = me.getPullTpl(), element = me.element;
	...
	onBounceTop : function(y) {
		var me = this, pullHeight = me.pullHeight, list = me.getList(), scroller = list
